    ...
    <div className="flex flex-col items-center space-y-2">
      <div className="flex flex-col space-y-2 ">
        ...
        <ul className="list-disc pl-4">
          ...
          <li>
            Confidence: {prediction ? <span>{prediction.confidence}%</span> : <span>{'N/A'}</span>}
          </li>
        </ul>
        <div>File Stats</div>
        <ul className="list-disc pl-4">
          <li>Width: {preview ? <span>{preview.width}px</span> : <span>{'N/A'}</span>}</li>
          <li>Height: {preview ? <span>{preview.height}px</span> : <span>{'N/A'}</span>}</li>
        </ul>
      </div>
      {uploadedFile && (
